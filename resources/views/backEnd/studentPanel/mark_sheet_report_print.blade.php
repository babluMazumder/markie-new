    ...
    <table  style="width: 100%; border: 0px;"> 
            <tr > 
                ...
                <td style="text-align: center; width: 70%"> 
                    <span class="text-white" style="font-size: 18px;"> {{isset($school_name)?$school_name:'Infix School Management ERP'}} </span> 
                    <p class="mb-0"> {{isset($address)?$address:'Infix School Address'}} </p>
                </td> 
                <td style="width: 15%">
                        ...
                        <div class="single-report-admit">
                            <div class=""> 
                                ...
                                <div class="">
                                    ...
                                    <h5 style="text-align: center; font-weight:bold; font-size:14px">Marks Sheet of {{$exam_details->title}}</h5>
