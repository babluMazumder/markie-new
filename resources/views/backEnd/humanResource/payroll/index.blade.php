                      ...
                      <tr>
                        ...
                        @if(!empty($getPayrollDetails))
                          ...
                          @if(userPermission(176))
                            ...
                            <a class="modalLink" data-modal-size="modal-lg" title="Proceed to pay" href="{{route('pay-payroll',[$getPayrollDetails->id,$value->role_id])}}"><button class="primary-btn small tr-bg">@lang('lang.proceed_to_pay') </button></a>
                            @endif
                        ...
                        @endif
                            ...
                            <a class="modalLink" data-modal-size="modal-lg" title="View Payslip Details" href="{{route('view-payslip', $getPayrollDetails->id)}}"><button class="primary-btn small tr-bg">@lang('lang.view_payslip')</button></a>
                            @endif
                        @endif
                            ...
                            <a class="" href="{{route('generate-Payroll',[@$value->id,@$payroll_month,@$payroll_year])}}"><button class="primary-btn small tr-bg"> @lang('lang.generate_payroll')</button></a>
                            @endif
                        @endif
                        </td>
                    </tr>
