                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="basicSalary">@lang('lang.basic_salary') ({{generalSetting()->currency_symbol}})</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="gross_salary">@lang('lang.gross_salary')  ({{generalSetting()->currency_symbol}})</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30 mb-30">
                                        ...
                                        <label for="net_salary">@lang('lang.net_salary') ({{generalSetting()->currency_symbol}})</label>
                                        <span class="focus-border"></span>
