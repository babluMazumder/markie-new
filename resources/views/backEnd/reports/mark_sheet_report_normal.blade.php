                                                    ...
                                                    <tr class="numbered_table_row" >
                                                        ...
                                                        <td class="border-0" >
                                                            <div class="school_mark">
                                                                <p class="ssc_text" > {{$exam_details->title}} -  {{$student_detail->className->class_name}}({{$student_detail->section->section_name}})</p> 
                                                                {{-- <div>
                                                  ...
                                                  <table style="width:100%" class="border-0">
                                                        <tbody><tr> 
                                                            <td class="border-0"><p class="result-date" style="text-align:left; float:left; display:inline-block; margin-top:50px; padding-left: 0;">
                                                               ...
                                                               @lang('lang.date_of_publication_of_result') : <b> {{@date_format(date_create($mark_sheet->first()->created_at),"F j, Y, g:i a")}}</b></b>
                                            </p></td>
                                                            <td class="border-0"> 
