    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-30 mt-30">@lang('lang.class_report_for_class') {{@$search_class->class_name}} {{$section != ""? 'section ('. $section->section_name.')': ''}}</h3>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value text-left text-uppercase">
                                                @lang('lang.collection')({{generalSetting()->currency_symbol}})
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value text-left text-uppercase">
                                                @lang('lang.due')({{generalSetting()->currency_symbol}})
                                            </div>
                                        </div>
                                    </div>
                                </div>
