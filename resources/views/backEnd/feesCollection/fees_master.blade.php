                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                                ...
                                                <div class="dropdown mb-20">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                       @if(userPermission(120))
                                                        ...
                                                        <a class="dropdown-item" href="{{route('fees-master-edit', [$fees_master->id])}}">@lang('lang.edit')</a>
                                                       @endif
                                                        @if(userPermission(121))

                                                        <a class="dropdown-item deleteFeesMasterSingle" data-toggle="modal" data-target="#deleteFeesMasterSingle{{$fees_master->id}}"
                                        ...
                                        <div class="modal fade admin-query" id="deleteFeesMasterSingle{{$fees_master->id}}" >
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">@lang('lang.delete') @lang('lang.fees') @lang('lang.type')</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                                ...
                                                                <input type="hidden" name="id" id="" value="{{$fees_master->id}}">
                                    ...
                                    <td valign="top">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                @if(userPermission(122))

                                                <a class="dropdown-item" href="{{route('fees_assign', [$fees_master->fees_group_id])}}">@lang('lang.assign')/@lang('lang.view')</a>
                                                @endif
                                                <a class="dropdown-item deleteFeesMasterGroup" data-toggle="modal" href="#" data-id="{{$fees_master->fees_group_id}}" data-target="#deleteFeesMasterGroup{{$fees_master->fees_group_id}}">@lang('lang.delete')</a>
                                            </div>
                                        </div>
                                        @endif
                                        <div class="modal fade admin-query" id="deleteFeesMasterGroup{{$fees_master->fees_group_id}}" >
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">@lang('lang.delete') @lang('lang.fees') @lang('lang.master')</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <input type="hidden" name="id" value="{{$fees_master->fees_group_id}}">
                                                            <button class="primary-btn fix-gr-bg" type="submit">@lang('lang.delete')</button>
                                                            {{ Form::close() }}
                                                        </div>
                                                    </div>
