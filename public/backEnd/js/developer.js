(function($) {
    ...
    addMoreEarnings = () => {
        ...
        var row = (table.insertRow(table_len).outerHTML =
            "<tr id='row" +
            id +
            "'><td width='70%' class='pr-30'><div class='input-effect mt-10'><input class='primary-input form-control' placeholder='Type' type='text' id='earningsType" +
            id +
            "' name='earningsType[]'><label for='earningsType" +
            id +
            "'></label><span class='focus-border'></span></div></td><td width='20%'><div class='input-effect mt-10'><input class='primary-input form-control' type='number' placeholder='Value' oninput='this.value = Math.abs(this.value)' id='earningsValue" +
            id +
    ...
    addDeductions = () => {
        ...
        var row = (table.insertRow(table_len).outerHTML =
            "<tr id='DeductionRow" +
            id +
            "'><td width='70%' class='pr-30'><div class='input-effect mt-10'><input class='primary-input form-control' placeholder='Type' type='text' id='deductionstype" +
            id +
            "' name='deductionstype[]'><label for='deductionstype" +
            id +
            "'></label><span class='focus-border'></span></div></td><td width='20%'><div class='input-effect mt-10'><input class='primary-input form-control ' oninput='this.value = Math.abs(this.value)' type='number' placeholder='Value' id='deductionsValue" +
            id +
            "' name='deductionsValue[]'><label for='deductionsValue" +
            id +
            "'></label><span class='focus-border'></span></div></td><td width='10%' class='pt-30'><button class='primary-btn icon-only fix-gr-bg close-deductions' onclick='delete_deduction(" +
            id +
            ")'><span class='ti-close'></span></button></td></tr>");
    };
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var tr =
                    ...
                    arrayNumber +
                    '">' +
                    '<td class="border-top-0"><div class="input-effect">';

                tr +=
                    '<select class="niceSelect form-control" name="item_id[]" id="productName' +
                    count +
                    '" style="display:none">' +
                ...
                tr += "<ul class='list'>";
                tr +=
                    "<li data-value='' data-display='Select Item' class='option selected'>Select Item</li>";
                ...
                tr +=
                    "</div></td>" +
                    '<td class="border-top-0" width=""><div class="input-effect">' +
                    '<input type="text" name="unit_price[]" onkeyup="getTotalByPrice(' +
                    count +
                    ')" id="unit_price' +
                    count +
                    '"  autocomplete="off" class="primary-input form-control"  min="1" />' +
                    ...
                    ')" id="quantity' +
                    count +
                    '" autocomplete="off"  class="form-control primary-input" />' +
                    ...
                    count +
                    '" autocomplete="off" class="form-control primary-input" value= "0.00" />' +
    ...
    addRowMark = () => {
        ...
        newRow +=
            "<input class='primary-input form-control' type='text' placeholder='title' id='exam_title' name='exam_title[]' autocomplete='off'>";
        ...
        newRow += "<div class='input-effect'>";
        newRow +=
            "<input class='primary-input form-control exam_mark' type='number' id='exam_mark' name='exam_mark[]' autocomplete='off'>";
        newRow += "</div>";
        newRow += "</td> ";
