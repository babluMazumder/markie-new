    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('exam_schedule_create')); ?>"><?php echo app('translator')->get('lang.exam_schedule'); ?> <?php echo app('translator')->get('lang.create'); ?></a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php
                             ...
                             //   $assigned_routine_subject = assignedRoutineSubject($class_id, $section_id, $exam_id, $assign_subject->subject_id);

                                $assigned_routine = assignedRoutine($class_id, $section_id, $exam_id, $assign_subject->subject_id, $exam_period->id);
                            ...
                            <td>
                                <?php if(@$assigned_routine == ""): ?>
                                    ...
                                    <div class="col-lg-6">
                                        <a href="<?php echo e(route('add-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $section_id, $exam_id])); ?>" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="Create exam routine">
                                ...
                                <?php else: ?>
                                    <div class="col-lg-6">
                                        <span class=""><?php echo e(@$assigned_routine->classRoom !=""?@$assigned_routine->classRoom->room_no:""); ?></span>
                                        <br>
                                        <span class="">                                           
                                         <?php echo e(@$assigned_routine->date != ""? dateConvert($assigned_routine->date):''); ?>

                                        </span></br>
                                        <a href="<?php echo e(route('edit-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $section_id, $exam_id, $assigned_routine->id])); ?>" class="modalLink" data-modal-size="modal-md" title="Edit Exam routine"><span class="ti-pencil-alt" id="addClassRoutine"></span></a>

                                        <a href="<?php echo e(route('delete-exam-routine-modal', [$assigned_routine->id])); ?>" class="modalLink" data-modal-size="modal-md" title="Delete exam routine"><span class="ti-trash" id="addClassRoutine"></span></a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/examination/exam_schedule_create.blade.php ENDPATH**/ ?>