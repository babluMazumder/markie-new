            ...
            <div class="row">
                <div class="col-lg-8 col-md-6 col-sm-6">
                    <div class="main-title">
                        <h3 class="mb-30 lol"><?php echo app('translator')->get('lang.select_criteria'); ?></h3>
                    </div>
                </div>
...
<section class="mt-20">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6">
                <a href="<?php echo e(route('exam_schedule_print',  [$exam_id, $class_id, $section_id])); ?>" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> <?php echo app('translator')->get('lang.print'); ?></a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/examination/exam_schedule.blade.php ENDPATH**/ ?>