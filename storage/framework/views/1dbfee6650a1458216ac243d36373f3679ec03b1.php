                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            type="number" name="exam_marks" id="exam_mark_main" autocomplete="off" onkeypress="return isNumberKey(event)" value="<?php echo e(isset($exam)? $exam->exam_mark: 0); ?>" required="" min="0">
                                  ...
                                  <tr id="row1" class="mt-40">
                                    ...
                                    <td class="border-top-0">
                                        <div class="input-effect">
                                            ...
                                            type="number" id="exam_mark" name="exam_mark[]" autocomplete="off"  onkeypress="return isNumberKey(event)"  value="<?php echo e(isset($editData)? $editData->exam_mark : 0); ?>">
                                        </div>
                                    </td> 
                                    <td class="border-top">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/examination/exam.blade.php ENDPATH**/ ?>