    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#"><?php echo app('translator')->get('lang.class_routine'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6 pull-right">
                <a href="<?php echo e(route('classRoutinePrint', [@$class_id, @$section_id])); ?>" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> Print</a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentPanel/class_routine.blade.php ENDPATH**/ ?>