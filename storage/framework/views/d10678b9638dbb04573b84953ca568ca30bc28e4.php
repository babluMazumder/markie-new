...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.manage'); ?> <?php echo app('translator')->get('lang.student_certificate'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.admin_section'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.student_certificate'); ?></a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="main-title">
                            <h3 class="mb-30"><?php if(isset($certificate)): ?>
                                ...
                                <?php else: ?>
                                    <?php echo app('translator')->get('lang.add'); ?>
                                <?php endif; ?>
                                <?php echo app('translator')->get('lang.certificate'); ?>
                            </h3>
                        </div>
                        <?php if(isset($certificate)): ?>
                            ...
                            <div class="add-visitor">
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.certificate'); ?> <?php echo app('translator')->get('lang.name'); ?> <span>*</span></label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.header_left_text'); ?><span></span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.body'); ?> (<?php echo app('translator')->get('lang.certificate_body_len'); ?>) <span></span></label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.footer_left_text'); ?> <span></span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.footer_center_text'); ?><span></span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.footer_right_text'); ?><span></span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12 d-flex">
                                        <p class="text-uppercase fw-500 mb-10"><?php echo app('translator')->get('lang.student_photo'); ?></p>
                                        <div class="d-flex radio-btn-flex ml-40">
                                            ...
                                            <div class="mr-30">
                                                ...
                                                <label for="relationMother"><?php echo app('translator')->get('lang.none'); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('file') ? ' is-invalid' : ''); ?>" id="placeholderInput" type="text" placeholder="<?php echo e(isset($certificate)? ($certificate->file != ""? getFilePath3($certificate->file):'Image *'): 'Image(1100 X 850)px *'); ?>" readonly>
                                            <span class="focus-border"></span>
            ...
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">  <?php echo app('translator')->get('lang.certificate'); ?> <?php echo app('translator')->get('lang.list'); ?></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('lang.background_image'); ?></th>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" data-toggle="modal" data-target="#showCertificateModal<?php echo e(@$certificate->id); ?>"  href="#"><?php echo app('translator')->get('lang.view'); ?></a>
                                                 <?php if(userPermission(51)): ?>
                                                <a class="dropdown-item" href="<?php echo e(route('student-certificate-edit',@$certificate->id)); ?>">edit</a>
                                                <?php endif; ?>
                                                 <?php if(userPermission(52)): ?>
                                                <a class="dropdown-item" data-toggle="modal" data-target="#deleteSectionModal<?php echo e(@$certificate->id); ?>"  href="#"><?php echo app('translator')->get('lang.delete'); ?></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->get('lang.delete'); ?> <?php echo app('translator')->get('lang.certificate'); ?></h4>
                                ...
                                <div class="modal fade admin-query" id="showCertificateModal<?php echo e(@$certificate->id); ?>">
                                    <div class="modal-dialog modal-dialog-centered large-modal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->get('lang.view'); ?> <?php echo app('translator')->get('lang.certificate'); ?></h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                                            ...
                                                            <div>
                                                                <div class="row justify-content-lg-between mb-5">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <p class="m-0"><?php echo app('translator')->get('lang.date'); ?>: <?php echo e(@$certificate->date); ?></p>
                                                                    </div>
                                                                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/admin/student_certificate.blade.php ENDPATH**/ ?>