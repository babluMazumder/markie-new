                                                    ...
                                                    <div class="col">
                                                        <div class="input-effect">
                                                            <input class="primary-input" type="text"
                                                                   ...
                                                                   placeholder="<?php echo e(isset($add_news)? ($add_news->image !="") ? getFilePath3($add_news->image) :'image' :'image'); ?>"
                                                                   readonly>
                                                            <span class="focus-border"></span>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/news/news_page.blade.php ENDPATH**/ ?>