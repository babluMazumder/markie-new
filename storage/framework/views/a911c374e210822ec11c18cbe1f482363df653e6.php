            ...
            <div class="col-lg-12">
                <div class='up_dash_menu'>
                    ...
                    <?php if(@$styles && Auth::user()->role_id == 1 && Auth::user()->is_administrator=='yes'): ?>
                        ...
                        <?php if(generalSetting()->ltl_rtl_btn==1 && Auth::user()->role_id==1 && Auth::user()->is_administrator=='yes'): ?>
                        ...
                        <ul class="nav navbar-nav mr-auto nav-setting flex-sm-row d-none d-lg-block colortheme">
                            <li class="nav-item active">
                                <select class="niceSelect infix_theme_rtl" id="infix_theme_rtl">
                                    ...
                                    ?>
                                        <option value="2" <?php echo e(textDirection()==2?'selected':''); ?>><?php echo app('translator')->get('lang.ltl'); ?></option>
                                        <option value="1" <?php echo e(textDirection()==1?'selected':''); ?>><?php echo app('translator')->get('lang.rtl'); ?></option>
                                </select>
                            </li>
                        </ul>
...
<?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/partials/menu.blade.php ENDPATH**/ ?>