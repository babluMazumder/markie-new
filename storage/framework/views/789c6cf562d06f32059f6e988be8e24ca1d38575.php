                        ...
                        foreach ($notices as $notice) {
                            ...
                            if (in_array($role_id, $inform_to)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('view-notice',@$notice->id)); ?>" title="View notice"  class="primary-btn small tr-bg modalLink" data-modal-size="modal-lg"><?php echo app('translator')->get('lang.view'); ?></a>
                                    </td>
                                </tr>
                                <?php
                            }
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/dashboard.blade.php ENDPATH**/ ?>