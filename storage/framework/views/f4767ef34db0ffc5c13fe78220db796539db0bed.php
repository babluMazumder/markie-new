                            ...
                            <table id="table_id_table" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th width="25%"><?php echo app('translator')->get('lang.roll'); ?> <?php echo app('translator')->get('lang.no'); ?></th>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/examination/exam_attendance.blade.php ENDPATH**/ ?>