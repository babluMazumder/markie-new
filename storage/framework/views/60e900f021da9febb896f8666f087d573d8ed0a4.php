                                ...
                                <ul>
                                    <?php if(moduleStatusCheck('ParentRegistration')== TRUE): ?>
                                        ...
                                        <?php if(isset($is_registration_permission) && $is_registration_permission->position==2): ?>
                                            ...
                                            <li><a href="<?php echo e(url('/parentregistration/registration')); ?>">Student
                                                    Registration</a></li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href1!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href1); ?>"><?php echo e($custom_link->link_label1); ?> </a>
                                        </li>

                                    <?php endif; ?>
                                    <?php if($custom_link->link_href5!=''): ?>
                                        <li><a href="<?php echo e($custom_link->link_href5); ?>"><?php echo e($custom_link->link_label5); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href9!=''): ?>
                                        <li><a href="<?php echo e($custom_link->link_href9); ?>"><?php echo e($custom_link->link_label9); ?></a>
                                        </li>

                                    <?php endif; ?>
                                    <?php if($custom_link->link_href13!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href13); ?>"><?php echo e($custom_link->link_label13); ?> </a>
                                        </li>
                                    <?php endif; ?>
                            ...
                            <nav>
                                <ul>
                                    <?php if($custom_link->link_href2!=''): ?>
                                        <li><a href="<?php echo e($custom_link->link_href2); ?>"><?php echo e($custom_link->link_label2); ?></a>
                                        </li>

                                    <?php endif; ?>
                                    <?php if($custom_link->link_href6!=''): ?>
                                        <li>
                                            <a href="<?php echo e(url($custom_link->link_href6)); ?>"><?php echo e($custom_link->link_label6); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href10!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href10); ?>"><?php echo e($custom_link->link_label10); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href14!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href14); ?>"><?php echo e($custom_link->link_label14); ?></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </nav>
                            ...
                            <nav>
                                <ul>
                                    <?php if($custom_link->link_href3!=''): ?>
                                        <li><a href="<?php echo e($custom_link->link_href3); ?>"><?php echo e($custom_link->link_label3); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href7!=''): ?>
                                        <li><a href="<?php echo e($custom_link->link_href7); ?>"><?php echo e($custom_link->link_label7); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href11!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href11); ?>"><?php echo e($custom_link->link_label11); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href15!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href15); ?>"><?php echo e($custom_link->link_label15); ?></a>
                                        </li>
                                    <?php endif; ?>
                            ...
                            <nav>
                                <ul>
                                    <?php if($custom_link->link_href4!=''): ?>
                                        <li><a href="<?php echo e($custom_link->link_href4); ?>"><?php echo e($custom_link->link_label4); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href8!=''): ?>
                                        <li><a href="<?php echo e($custom_link->link_href8); ?>"><?php echo e($custom_link->link_label8); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href12!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href12); ?>"><?php echo e($custom_link->link_label12); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($custom_link->link_href16!=''): ?>
                                        <li>
                                            <a href="<?php echo e($custom_link->link_href16); ?>"><?php echo e($custom_link->link_label16); ?></a>
                                        </li>
                                    <?php endif; ?>
...
<?php /**PATH F:\xamppSF\htdocs\laravel\infixedu_v5.2\resources\views/frontEnd/home/front_master.blade.php ENDPATH**/ ?>