                            ...
                            <div class="row mt-20">
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <span style="font-size: 17px; padding-right: 15px;"><?php echo app('translator')->get('lang.ltl_rtl'); ?>  </span>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    ?>
                                        <?php if(userPermission($permission_id)): ?>
                                            <label class="switch">
                                                <input type="checkbox"
                                                    class="switch_ltl_rtl_btn" <?php echo e(@$settings->ltl_rtl_btn == 0? '':'checked'); ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        <?php endif; ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/systemSettings/buttonDisableEnable.blade.php ENDPATH**/ ?>