...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.student_report'); ?> </h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.reports'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.student_report'); ?></a>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <select class="w-100 niceSelect bb form-control<?php echo e($errors->has('current_section') ? ' is-invalid' : ''); ?>" name="type">
                                        <option data-display="<?php echo app('translator')->get('lang.select_type'); ?>" value=""><?php echo app('translator')->get('lang.select_type'); ?></option>
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <select class="w-100 niceSelect bb form-control<?php echo e($errors->has('gender') ? ' is-invalid' : ''); ?>" name="gender">
                                        <option data-display="<?php echo app('translator')->get('lang.select_gender'); ?>" value=""><?php echo app('translator')->get('lang.select_gender'); ?></option>
                            ...
                            <table id="table_ids" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->get('lang.nid'); ?> <?php echo app('translator')->get('lang.no'); ?></th>
                                        <th><?php echo app('translator')->get('lang.Birth_Certificate_Number'); ?></th>
                                    </tr>
                                </thead>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentInformation/student_report.blade.php ENDPATH**/ ?>