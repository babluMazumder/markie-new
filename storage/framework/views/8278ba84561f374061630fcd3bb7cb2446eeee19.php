    ...
    <section class="admin-visitor-area up_admin_visitor empty_table_tab">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12">
                <a href="<?php echo e(route('database-upgrade')); ?>" class="primary-btn small fix-gr-bg">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'admin/update-system', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/systemSettings/updateSettings.blade.php ENDPATH**/ ?>