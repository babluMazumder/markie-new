...
<?php echo e($value->apply_date != ""? dateConvert($value->apply_date):''); ?>
                        ...
                        <td>
                            <a class="modalLink" data-modal-size="modal-md" title="<?php echo app('translator')->get('lang.view'); ?> <?php echo app('translator')->get('lang.leave'); ?> <?php echo app('translator')->get('lang.details'); ?>" href="<?php echo e(url('view-leave-details', $value->id)); ?>"><button class="primary-btn small tr-bg"> <?php echo app('translator')->get('lang.view'); ?> </button></a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?> 
...
<div role="tabpanel" class="tab-pane fade <?php echo e(Session::get('staffDocuments') == 'active'? 'show active':''); ?>" id="staffDocuments">
    <div class="white-box">
        ...
        cellspacing="0">
            <thead class="d-block">
                <tr class="d-flex">
                    <th class="col-8"><?php echo app('translator')->get('lang.document'); ?> <?php echo app('translator')->get('lang.title'); ?></th>
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    <td class="col-8"><?php echo app('translator')->get('lang.joining_letter'); ?></td>
                    <td class="col-4">
                        <a href="<?php echo e(route('download-staff-joining-letter',showDocumentName($staffDetails->joining_letter))); ?>">
                ...
                <tr class="d-flex">
                    <td class="col-8"><?php echo app('translator')->get('lang.resume'); ?></td>
                    <td class="col-4">
                        <a href="<?php echo e(route('download-resume',showDocumentName($staffDetails->resume))); ?>">
                            <button class="primary-btn tr-bg text-uppercase bord-rad">
                                <?php echo app('translator')->get('lang.download'); ?>
                                <span class="pl ti-download"></span>
                            </button>
                ...
                <tr class="d-flex">
                    <td class="col-8"><?php echo app('translator')->get('lang.other_documents'); ?></td>
                    <td class="col-4">
                        <a href="<?php echo e(route('download-other-document',showDocumentName($staffDetails->other_document))); ?>">
                            <button class="primary-btn tr-bg text-uppercase bord-rad">
                                <?php echo app('translator')->get('lang.download'); ?>
                                <span class="pl ti-download"></span>
                            </button>
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a class="primary-btn tr-bg text-uppercase bord-rad" href="<?php echo e(route('download-staff-document',showDocumentName($value->file))); ?>">
                            <?php echo app('translator')->get('lang.download'); ?>
                                <span class="pl ti-download"></span>
                        </a>
                        <a class="primary-btn icon-only fix-gr-bg modalLink" title="Delete Document" data-modal-size="modal-md"  href="<?php echo e(route('delete-staff-document-view',$value->student_staff_id)); ?>">
...
<?php echo e($timeline->date != ""? dateConvert($timeline->date):''); ?>
                            ...
                            <div class="sub-activity-box d-flex">
                                ...
                                <div class="close-activity">
                                    ...
                                    <a href="<?php echo e(route('download-staff-timeline-doc',showTimelineDocName($timeline->file))); ?>" class="primary-btn tr-bg text-uppercase bord-rad">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/humanResource/viewStaff.blade.php ENDPATH**/ ?>