                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input
                                                    ...
                                                    placeholder="<?php echo e(isset($editData->upload_file) && @$editData->upload_file != ""? getFilePath3(@$editData->upload_file):'Attach File *'); ?>"
                                    ...
                                    <?php $__currentLoopData = $uploadContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td  data-sort="<?php echo e(strtotime(@$value->upload_date)); ?>" >
                                                 <?php echo e(@$value->upload_date != ""? dateConvert(@$value->upload_date):''); ?> </td>
                                                    ...
                                                    <?php if(userPermission(91)): ?>
                                                        ...
                                                        <?php if(userPermission(90)): ?>
                                                            <a class="dropdown-item"
                                                               href="<?php echo e(route('download-content-document',getFilePath3(@$value->upload_file))); ?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <a href="<?php echo e(route('delete-upload-content', [@$value->id])); ?>"
                                                               class="text-light">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/teacher/uploadContentList.blade.php ENDPATH**/ ?>