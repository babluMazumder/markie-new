...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
        ...
        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'generate_login_card_print', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'target' => '_blank'])); ?>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td> 
                                        <?php echo e(@$student->date_of_birth != ""? DateConvat(@$student->date_of_birth):''); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/admin/generate_login_card.blade.php ENDPATH**/ ?>