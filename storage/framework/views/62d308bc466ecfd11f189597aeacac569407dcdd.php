                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <input type="hidden" name="id"
                                                       value="<?php echo e(isset($marks_grade)? $marks_grade->id: ''); ?>">
                                                <label><?php echo app('translator')->get('lang.percent_upto'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                        ...
                        <div class="col-lg-12">
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('lang.grade'); ?> <?php echo app('translator')->get('lang.name'); ?></th>
                                    <th><?php echo app('translator')->get('lang.gpa'); ?></th>
                                    <th><?php echo app('translator')->get('lang.percent_from'); ?></th>
                                    <th><?php echo app('translator')->get('lang.percent_upto'); ?></th>
                                ...
                                <?php $__currentLoopData = $marks_grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marks_grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(@$marks_grade->percent_from); ?></td>
                                        <td><?php echo e(@$marks_grade->percent_upto); ?></td>
                                        <td>
                                            <div class="dropdown">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/examination/marks_grade.blade.php ENDPATH**/ ?>