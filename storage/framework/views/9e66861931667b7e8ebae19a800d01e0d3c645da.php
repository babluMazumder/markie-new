                    ...
                    <?php if(userPermission(11)): ?>
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuAdmin">
                                ...
                                <?php endif; ?>
                                <li>
                                    <a href="<?php echo e(route('generate_new_password')); ?>">Generate New Password</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('generate_login_card')); ?>">Generate Login card</a>
                                </li>
                            </ul>
                        </li>
...
<?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/partials/sidebar.blade.php ENDPATH**/ ?>