                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                         ...
                                         <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('capacity') ? ' is-invalid' : ''); ?>" type="number" name="capacity" autocomplete="off" value="<?php echo e(isset($class_room)? $class_room->capacity: old('capacity')); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/academics/class_room.blade.php ENDPATH**/ ?>