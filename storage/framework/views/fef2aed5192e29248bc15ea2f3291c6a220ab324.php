...
<style>
    ...
    .studentInfoTable td, .studentInfoTable th {
...
<div class="container-fluid"> 
    <table  style="width: 100%; border: 0px;"> 
            <tr > 
                <td style="width: 15%">
                    <img class="logo-img" src="<?php echo e(url('/')); ?>/<?php echo e($generalSetting->logo); ?>" alt="" width="80" >
                </td>
                <td style="text-align: center; width: 70%"> 
                    <h4 class="" style="font-size: 18px"> <?php echo e(isset($school_name)?$school_name:'Infix School Management ERP'); ?> </h4> 
                    <p class="mb-0"> <?php echo e(isset($address)?$address:'Infix School Address'); ?> </p>
                </td> 
                <td style="width: 15%">
                        ...
                        <div class="single-report-admit">
                            <div class=""> 
                                ...
                                <div class="">
                                    ...
                                    <h5 style="text-align: center; font-weight:bold; font-size:14px">Marks Sheet of <?php echo e($exam_details->title); ?></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td width="30%" style="padding: 0px !important; margin: 0px !important; border: none !important; border-right: none !important;">
                                                ...
                                                <table class="w-100 table   table-bordered marksheet principal-signature" style="padding: 0px !important; margin: 0px !important; border-bottom: none !important; border-left: none !important;">
                                                    ...
                                                    <tr>
                                                        <th colspan="4" height="40" style="margin: 0px !important; border-bottom: none !important; border-right: none !important; font-size: 36px;">
                                                            <?php
...
<?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/reports/mark_sheet_report_student_print.blade.php ENDPATH**/ ?>