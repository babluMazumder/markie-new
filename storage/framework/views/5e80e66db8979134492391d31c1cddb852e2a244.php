                                        ...
                                        <?php endif; ?>
                                            ...
                                            <div class="row mt-20">                                                 
                                               <script src="<?php echo e(asset('public/backEnd/')); ?>/vendors/js/print/2.1.1_jquery.min.js"></script>
                                                ...
                                                <div class="col-lg-4 mt-40"> 
                                                    <p><?php echo app('translator')->get('lang.set_permission_in'); ?> <b><?php echo app('translator')->get('lang.home'); ?></b></p>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/systemSettings/homePageBackend.blade.php ENDPATH**/ ?>