                            ...
                            <div class="white-box">
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5">
                                            <div class="">
                                                <?php echo app('translator')->get('lang.national_iD_number'); ?>
                                            </div>
                                        </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5">
                                            <div class="">
                                                <?php echo app('translator')->get('lang.local_Id_Number'); ?>
                                            </div>
                                        </div>
                                ...
                                <table class="display school-table school-table-style res_scrol" cellspacing="0" width="100%">
                                    ...
                                    <td>
                                        ...
                                        <tr>
                                            ...
                                            <?php elseif(@$payment->payment_mode == "bank"): ?>
                                            <?php echo e('Bank'); ?>
                                ...
                                <div class="white-box no-search no-paginate no-table-info mb-2">
                                    ...
                                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                        ...
                                        <?php $__currentLoopData = $get_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo e(!empty($schedule_by_subject->date)? dateConvert($schedule_by_subject->date):''); ?></td>
                        ...
                        <div role="tabpanel" class="tab-pane fade <?php echo e(Session::get('studentDocuments') == 'active'? 'show active':''); ?>" id="studentDocuments">
                            <div class="white-box">
                                ...
                                <table id="" class="table simple-table table-responsive school-table"
                                    ...
                                    <thead class="d-block">
                                    <tr class="d-flex">
                                        <th class="col-3"><?php echo app('translator')->get('lang.document'); ?> <?php echo app('translator')->get('lang.title'); ?></th>
                                            ...
                                            <td class="col-3">
                                                <?php if(file_exists($student_detail->document_file_1)): ?>
                                                    <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                     ...
                                                     <a class="primary-btn icon-only bg-danger text-light delete-doc" onclick="deleteDoc(<?php echo e($student_detail->id); ?>,1)"  data-id="1"  href="#">
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-3">
                                                <?php if(file_exists($student_detail->document_file_2)): ?>
                                                    ...
                                                    <a class="primary-btn icon-only bg-danger text-light delete-doc" onclick="deleteDoc(<?php echo e($student_detail->id); ?>,2)"  data-id="2"  href="#">
                                                        <span class="ti-trash"></span>
                                                    </a>
                                                <?php endif; ?>    
                                            </td>
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-3">
                                                <?php if(file_exists($student_detail->document_file_3)): ?>
                                                    ...
                                                    <a class="primary-btn icon-only bg-danger text-light delete-doc" onclick="deleteDoc(<?php echo e($student_detail->id); ?>,3)"  data-id="3"  href="#">
                                                        <span class="ti-trash"></span>
                                                    </a>
                                                <?php endif; ?>
                                            </td>
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-3">
                                                <?php if(file_exists($student_detail->document_file_4)): ?>
                                                    ...
                                                    <a class="primary-btn icon-only bg-danger text-light delete-doc" onclick="deleteDoc(<?php echo e($student_detail->id); ?>,4)"  data-id="4"  href="#">
                                                        <span class="ti-trash"></span>
                                                    </a>
                                                <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentInformation/student_view.blade.php ENDPATH**/ ?>