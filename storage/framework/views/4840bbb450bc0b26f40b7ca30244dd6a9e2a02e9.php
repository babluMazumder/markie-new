                    ...
                    <div class="">
                        ...
                        <div class="row mb-40">
                           ...
                           <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input form-control<?php echo e($errors->has('exam_average_mark') ? ' is-invalid' : ''); ?>"
                                        type="number" name="exam_average_mark" autocomplete="off" value="<?php echo e(isset($editData)? $editData->exam_pass_mark : old('exam_average_mark')); ?>">
                                        <label>Exam Pass Mark <span>*</span></label>
                                        <span class="focus-border"></span>
                                        <?php if($errors->has('exam_average_mark')): ?>
                                        <span class="invalid-feedback" role="alert">
                                            <strong><?php echo e($errors->first('exam_average_mark')); ?></strong>
                                        </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input form-control<?php echo e($errors->has('file_size') ? ' is-invalid' : ''); ?>"
                                    type="number" name="file_size" autocomplete="off" value="<?php echo e(isset($editData)? @$editData->file_size : old('file_size')); ?>" id="file_size" >
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/systemSettings/updateGeneralSettings.blade.php ENDPATH**/ ?>