                                ...
                                <?php $__currentLoopData = $online_exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $online_exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(!in_array(@$online_exam->id, @$marks_assigned)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                             <?php if(@$online_exam->is_running==1): ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(@$online_exam->is_waiting==1): ?>
                                                                    <span class="btn primary-btn small  fix-gr-bg"
                                                                        style="background:green">Waiting</span>
                                                                <?php endif; ?>
                                                                <?php if( @$online_exam->is_closed==1): ?>
                                                                    <span class="btn primary-btn small  fix-gr-bg"
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentPanel/online_exam.blade.php ENDPATH**/ ?>