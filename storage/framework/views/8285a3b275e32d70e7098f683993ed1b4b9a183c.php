...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.exam_type'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.examinations'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.add_exam_type'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="offset-lg-9 col-lg-3 text-right col-md-12 mb-20">
                <a href="<?php echo e(route('exam')); ?>" class="primary-btn small fix-gr-bg">
                    ...
                    <?php echo app('translator')->get('lang.exam_setup'); ?>
                </a>
            </div>
                        ...
                        <div class="main-title">
                            <h3 class="mb-30"><?php if(isset($exam_type_edit)): ?>
                                ...
                                <?php else: ?>
                                    <?php echo app('translator')->get('lang.add'); ?>
                                <?php endif; ?>
                                <?php echo app('translator')->get('lang.exam_type'); ?>
                            </h3>
                        </div>
                        <?php if(isset($exam_type_edit)): ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label> <?php echo app('translator')->get('lang.exam_name'); ?> <span>*</span></label>
                                    ...
                                    <?php if(isset($exam_type_edit)): ?>
                                        <div class="col-lg-12 mt-30-md">
                                            <select class="w-100 bb niceSelect form-control <?php echo e($errors->has('active_status') ? ' is-invalid' : ''); ?>" id="active_status" name="active_status">
                                                ...
                                                <option value="1" <?php echo e((@$exam_type_edit->active_status ==1) ? 'selected' :''); ?>> <?php echo app('translator')->get('lang.active'); ?></option> 
                                                <option value="0" <?php echo e((@$exam_type_edit->active_status ==0) ? 'selected' :''); ?>> <?php echo app('translator')->get('lang.inactive'); ?></option> 
                                            </select>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0 "><?php echo app('translator')->get('lang.exam_type'); ?> <?php echo app('translator')->get('lang.list'); ?></h3>
                        </div>
                    </div>
                </div>
                            ...
                            <thead>
                               <?php if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('lang.exam_name'); ?></th>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(route('exam_type_edit', [$exams_type->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                        <?php endif; ?>
                                                        <?php if(userPermission(211)): ?>

                                                        <a class="dropdown-item" data-toggle="modal" data-target="#deleteSubjectModal<?php echo e(@$exams_type->id); ?>"  href="#"><?php echo app('translator')->get('lang.delete'); ?></a>
                                                   <?php endif; ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                 <a  class="primary-btn small tr-bg" href="<?php echo e(route('exam-marks-setup',$exams_type->id)); ?>">
                                                    <span class="pl ti-settings"></span> <?php echo app('translator')->get('lang.exam_setup'); ?>
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->get('lang.delete'); ?> <?php echo app('translator')->get('lang.exam_type'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/examination/exam_type.blade.php ENDPATH**/ ?>