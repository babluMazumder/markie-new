    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#"><?php echo app('translator')->get('lang.marks_register'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
            ...
            <?php if(userPermission(223)): ?>
                ...
                <div class="col-lg-4 text-md-right text-left col-md-6 mb-30-lg col-sm-6 text_sm_right">
                    <a href="<?php echo e(route('marks_register_create')); ?>" class="primary-btn small fix-gr-bg">
                        ...
                        <?php echo app('translator')->get('lang.add'); ?> <?php echo app('translator')->get('lang.marks'); ?>
                    </a>
        ...
        <div class="row mt-40">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-0"><?php echo app('translator')->get('lang.marks_register'); ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="exam_setup_ids[]" value="<?php echo e(@$part->id); ?>">
                                    ...
                                    <input class="primary-input marks_input" type="number" name="marks[<?php echo e(@$student->id); ?>][<?php echo e(@$part->id); ?>]" value="0" max="100">
                                    ...
                                    <label><?php echo e(@$part->exam_title); ?> <?php echo app('translator')->get('lang.mark'); ?></label>
                            ...
                            <td>
                                <div class="input-effect">
                                    ...
                                    <label for="subject_<?php echo e(@$student->id); ?>_<?php echo e(@$student->admission_no); ?>"><?php echo app('translator')->get('lang.yes'); ?></label>
                                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/examination/masks_register.blade.php ENDPATH**/ ?>