            ...
            <div class="col-lg-8 pull-right">
                <div class="main-title">
                     <div class="print_button pull-right mt-30">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'mark-sheet-report/print', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'mark_sheet_report', 'target' => '_blank'])); ?>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="input-effect">
                                                            ...
                                                            <input
                                                                    ...
                                                                    type="text" name="teacher_comment" autocomplete="off" value="<?php echo e(@$teacher_comment); ?>">
                                                ...
                                                <div class="row mt-35">
                                                    <div class="col-lg-12">
                                                        <div class="input-effect">
                                                            <input
                                                                    class="primary-input form-control"
                                                                    type="text" name="principal_comment" autocomplete="off"  value="<?php echo e(@$principle_comment); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/reports/mark_sheet_report_student.blade.php ENDPATH**/ ?>