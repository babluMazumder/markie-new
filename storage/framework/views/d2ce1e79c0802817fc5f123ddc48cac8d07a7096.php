...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                <a href="<?php echo e(route('staff-attendance-import')); ?>" class="primary-btn small fix-gr-bg pull-right sm_mb_20 sm2_mb_20"><span class="ti-plus pr-2"></span>Import Attendance</a>
            </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
<?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
            ...
            <div class="row mt-40">
                <div class="col-lg-12">
                    ...
                    <?php if(userPermission(166)): ?>

                    
                        <div class="col-lg-6 col-md-6 text-md-right">
                            <button type="submit" class="primary-btn fix-gr-bg mb-20" onclick="javascript: form.action='<?php echo e(route('staff-attendance-store')); ?>'">
                        ...
                        <div class="col-lg-12">
                            <table id="default_table" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <?php endif; ?>
                                    <tr>
                                        <th width="15%"><?php echo app('translator')->get('lang.staff'); ?> <?php echo app('translator')->get('lang.no'); ?></th>
                                        <th width="15%"><?php echo app('translator')->get('lang.staff'); ?> <?php echo app('translator')->get('lang.name'); ?></th>
                                        <th width="12%"><?php echo app('translator')->get('lang.role'); ?></th>
                                        ...
                                        <td>
                                            <div class="d-flex radio-btn-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <label for="attendanceH<?php echo e($already_assigned_staff->StaffInfo->id); ?>"><?php echo app('translator')->get('lang.holiday'); ?></label>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex radio-btn-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <label for="attendanceH<?php echo e($staff->id); ?>"><?php echo app('translator')->get('lang.holiday'); ?></label>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/humanResource/staff_attendance.blade.php ENDPATH**/ ?>