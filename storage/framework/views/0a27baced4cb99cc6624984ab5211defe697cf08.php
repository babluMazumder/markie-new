...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.add_new_staff'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="<?php echo e(route('staff_directory')); ?>"><?php echo app('translator')->get('lang.human_resource'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.add_new_staff'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('lang.staff'); ?> <?php echo app('translator')->get('lang.information'); ?> </h3>
                </div>
            </div>
            <div class="col-lg-4 text-md-right text-left col-md-6 mb-30-lg">
                <a href="<?php echo e(route('staff_directory')); ?>" class="primary-btn small fix-gr-bg">
                    <?php echo app('translator')->get('lang.all'); ?> <?php echo app('translator')->get('lang.staff_list'); ?>
                </a>
            </div>
        </div>
                    ...
                    <div class="row mb-30">
                        <div class="col-lg-3">
                            <div class="input-effect">
                                ...
                                <label><?php echo app('translator')->get('lang.staff_no'); ?> <span>*</span> </label>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('department_id') ? ' is-invalid' : ''); ?>" name="department_id" id="department_id">
                                    <option data-display="Department *" value=""><?php echo app('translator')->get('lang.select'); ?> </option>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('designation_id') ? ' is-invalid' : ''); ?>" name="designation_id" id="designation_id">
                                    <option data-display="Designations *" value=""><?php echo app('translator')->get('lang.select'); ?> </option>
                    ...
                    <div class="col-lg-3">
                        <div class="input-effect">
                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('gender_id') ? ' is-invalid' : ''); ?>" name="gender_id">
                                <option data-display="Gender *" value=""><?php echo app('translator')->get('lang.gender'); ?> *</option>
                ...
                <div class="col-lg-3">
                    <div class="input-effect">
                        <select class="niceSelect w-100 bb form-control" name="marital_status">
                            <option data-display="<?php echo app('translator')->get('lang.marital_status'); ?>" value=""><?php echo app('translator')->get('lang.marital_status'); ?></option>

                            <option <?php echo e(old('marital_status') == 'married'? 'selected': ''); ?> value="married"><?php echo app('translator')->get('lang.married'); ?></option>
                            <option <?php echo e(old('marital_status') == 'unmarried'? 'selected': ''); ?> value="unmarried"><?php echo app('translator')->get('lang.unmarried'); ?></option>
                    ...
                    <div class="row no-gutters input-right-icon">
                        <div class="col">
                            <div class="input-effect">
                                ...
                                placeholder="<?php echo e(isset($editData->file) && $editData->file != '' ? getFilePath3($editData->file):'Staff Photo *'); ?>"
                                disabled>
                                <span class="focus-border"></span>
        ...
        <div class="col-lg-3">
            <div class="input-effect">
                <select class="niceSelect w-100 bb form-control" name="contract_type">
                    <option data-display="<?php echo app('translator')->get('lang.contract_type'); ?>" value=""> <?php echo app('translator')->get('lang.contract_type'); ?></option>
                    <option value="permanent"><?php echo app('translator')->get('lang.permanent'); ?> </option>
                    <option value="contract"> <?php echo app('translator')->get('lang.contract'); ?></option>
                </select>
                <span class="focus-border"></span>
...
<div class="row mt-40">
    <div class="col-lg-12">
        <div class="main-title">
            <h4><?php echo app('translator')->get('lang.bank_info_details'); ?></h4>
        </div>
    </div>
</div>
<div class="row mb-30">
...
<div class="row mb-20">
   <div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderResume" placeholder="<?php echo e(isset($editData->resume) && $editData->resume != ""? getFilePath3($editData->resume):'Resume'); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderJoiningLetter" placeholder="<?php echo e(isset($editData->joining_letter) && $editData->joining_letter != ""? getFilePath3($editData->joining_letter):'Joining Letter'); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderOthersDocument" placeholder="<?php echo e(isset($editData->other_document) && $editData->other_document != ""? getFilePath3($editData->other_document):'Others Documents'); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
...
<div class="row mt-40">
    <div class="col-lg-12 text-center">
        <button class="primary-btn fix-gr-bg">
            ...
            <?php echo app('translator')->get('lang.save'); ?> <?php echo app('translator')->get('lang.staff'); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/humanResource/addStaff.blade.php ENDPATH**/ ?>