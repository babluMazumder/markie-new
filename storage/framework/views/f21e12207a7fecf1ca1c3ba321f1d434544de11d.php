                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="name text-left">
                                                <?php echo e(number_format($total_assign - $total_collection-$applied_discount, 2)); ?><input type="hidden" id="total_assign" name="total_assign" 
                                                value="<?php echo e(@$total_assign-$applied_discount); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/reports/class_report.blade.php ENDPATH**/ ?>