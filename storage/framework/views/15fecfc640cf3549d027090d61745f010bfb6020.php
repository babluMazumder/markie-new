                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12 ">
                                        <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('category') ? ' is-invalid' : ''); ?>" name="category">
                                            <option data-display=" <?php echo app('translator')->get('lang.category_name'); ?>" value=""><?php echo app('translator')->get('lang.category_name'); ?></option>
                                            <?php $__currentLoopData = $bookCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(isset($subject)): ?>
                                                    <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $subject->id? 'selected':''); ?>><?php echo e($value->category_name); ?></option>
                                                <?php else: ?>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <thead>
                               <?php if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    ...
                                    <th> <?php echo app('translator')->get('lang.category_name'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(@$subject->category_name); ?></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('library_subject_edit', [@$subject->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/library/subject.blade.php ENDPATH**/ ?>