<!-- <a href="<?php echo e(url('reset/password'.'/'.$data['email'].'/'.$data['random'])); ?>" target="_blank">Click here</a> -->
                                ...
                                <tr>
                                    <td align="center" class="m_img_mc_fix">
                                        <a href="" target="_blank">
                                            <img align="center" src="<?php echo e(asset(generalSetting()->logo)); ?>" alt="" width=""
                                                 height="" border="0" style="width:px; max-width:px;">
                                        </a>
                                    </td>
                                </tr>
                                <tr>
        ...
        <tr>
            <td align="center" style="padding: 0 5px 0 5px;">
                <table width="600" border="0" cellspacing="0" cellpadding="0"
                       style="background:linear-gradient(90deg, rgb(124, 50, 255) 0%, rgb(199, 56, 216) 51%, rgb(124, 50, 255) 100%) 0% 0% / 200%;"
                       class="m_wd_full">
                    <tbody>
                    <tr>
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" class="m_img_mc_fix">
                                        <img align="center"
                                             src="https://gallery.mailchimp.com/d942a4805f7cb9a8a6067c1e6/images/4440afa1-9973-4508-8483-272869e7bbf5.png"
                                             alt="" width="83" height="83" border="0"
                                             style="width:83px; max-width:83px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center"
                                        style="padding:25px 25px 0px 25px; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:32px; font-weight:bold; color:#ffffff; line-height:30px; text-align:center; display:block;">
                                        Reset Password
                                    </td>
                                </tr>
                                <tr>
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" border="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:14px 30px 14px 30px;text-transform:uppercase; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align:center; font-size: 14px; font-weight:bold; line-height: 1.3; color:#ffffff;">
                                                                            <a href="<?php echo e(url('reset/password'.'/'.$data['email'].'/'.$data['random'])); ?>"
                    ...
                    <tr>
                        <td style="padding:0 25px 0 25px;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center"
                                        style="font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:13px; font-weight:normal; color:#24252a; line-height:19px; text-align:center; display:block;"><?php echo e(@$email_template->email_footer_text); ?>
...
</html><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/auth/confirmation_reset.blade.php ENDPATH**/ ?>