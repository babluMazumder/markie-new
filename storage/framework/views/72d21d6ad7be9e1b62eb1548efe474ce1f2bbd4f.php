                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <thead>
                                <tr>
                                    <th><?php echo app('translator')->get('lang.dashboard'); ?> <?php echo app('translator')->get('lang.subject'); ?></th>
                                    <th><?php echo app('translator')->get('lang.dashboard'); ?> <?php echo app('translator')->get('lang.teacher'); ?></th>
                                    <th><?php echo app('translator')->get('lang.dashboard'); ?> <?php echo app('translator')->get('lang.subject_type'); ?></th>
                                </tr>
                            </thead>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentPanel/student_subject.blade.php ENDPATH**/ ?>