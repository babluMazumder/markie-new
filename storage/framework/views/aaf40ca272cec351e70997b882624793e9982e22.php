                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-md" id="select_subject_div">
                                <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('subject') ? ' is-invalid' : ''); ?> select_subject" id="select_subject" name="subject">
                                    <option data-display="Select subject *" value=""><?php echo app('translator')->get('lang.select_subject'); ?> *</option>
                                </select>
        ...
        <div class="row mt-40">
            ...
            <div class="col-lg-6 no-gutters mb-30">
                <?php if(userPermission(536)): ?>
                    <a href="<?php echo e(route('subject-attendance/print', [$class_id, $section_id,$subject_id, $month, $year])); ?>" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> Print</a>
                <?php endif; ?>
            </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentInformation/subject_attendance_report_view.blade.php ENDPATH**/ ?>