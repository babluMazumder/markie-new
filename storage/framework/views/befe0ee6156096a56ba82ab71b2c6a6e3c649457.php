         ...
         <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'transport-route',
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               ...
                                               <?php if(userPermission(351)): ?>
                                                <a class="dropdown-item" href="<?php echo e(route('transport-route-edit', [@$route->id])); ?>"> <?php echo app('translator')->get('lang.edit'); ?></a>
                                               <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/transport/route.blade.php ENDPATH**/ ?>