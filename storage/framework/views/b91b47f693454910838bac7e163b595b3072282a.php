                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if(userPermission(516)): ?>
                                            <td width="10%"><a href="<?php echo e(route('contactPageEdit')); ?>" class="primary-btn small fix-gr-bg">edit</a></td>
                                        <?php endif; ?>
                                    </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/frontEnd/contact_us.blade.php ENDPATH**/ ?>