                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="w-100 mt-30 mb-20 table table-bordered meritList">
                                            <thead>
                                                <tr>
                                                    <th><?php echo app('translator')->get('lang.merit'); ?> <?php echo app('translator')->get('lang.position'); ?></th>
                                            ...
                                            <tbody>
                                                <?php $i=1; $subject_mark = []; $total_student_mark = 0; $total_student_mark_optional = 0; ?>
                                                    ...
                                                    $student_detail=App\SmStudent::where('id','=',$row->student_id)->where('academic_id', getAcademicId())->first();
                                                            $optional_subject='';
                                                                   
                                                            $get_optional_subject=App\SmOptionalSubjectAssign::where('student_id','=',$student_detail->id)->where('session_id','=',$student_detail->session_id)->where('academic_id', getAcademicId())->first();
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if(!empty($markslist)): ?>
                                                        <?php $__currentLoopData = $markslist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            ?> 
                                                            <td>  <?php echo e(!empty($mark)?$mark:0); ?> 
                                                                ...
                                                                <?php if(App\SmOptionalSubjectAssign::is_optional_subject($row->student_id,$get_subject_id[$count])): ?>
                                                                    ...
                                                                    <small>(<?php echo app('translator')->get('lang.additional_subject'); ?>)</small>
                                                                <?php endif; ?>
                                                            <?php
                                                            ...
                                                            if($row->result == 'F'){
                                                               ...
                                                               $c = 0;
                                                                ...
                                                                foreach ($subject_mark as $mark) {
                                                                    ...
                                                                    $grade_gpa = DB::table('sm_marks_grades')->where('percent_from','<=',$mark)->where('percent_upto','>=',$mark)->where('academic_id', getAcademicId())->where('academic_id', getAcademicId())->first();
                                                        ...
                                                        <td> 
                                                         ...
                                                         <td> 
                                                                ...
                                                                if($row->result == 'F'){
                                                                    ...
                                                                    $optional_grade_gpa = DB::table('sm_marks_grades')->where('from','<=',$grade)->where('up','>=',$grade)->where('academic_id', getAcademicId())->first();
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/reports/merit_list_report_normal.blade.php ENDPATH**/ ?>