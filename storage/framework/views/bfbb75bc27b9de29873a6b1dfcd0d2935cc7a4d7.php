        ...
        <div class="row">
                                ...
                                <div class="row no-gutters input-right-icon mb-20">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            placeholder="<?php echo e(isset($editData->file) && @$editData->file != ""? getFilePath3(@$editData->file):'Upload File'); ?> "  id="placeholderUploadContent" name="content_file">
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip" title="Disabled Images <?php echo app('translator')->get('lang.backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" ><?php echo app('translator')->get('lang.image'); ?> <?php echo app('translator')->get('lang.backup'); ?></button>
                    </span>
                              <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip" title="Disabled Full Project <?php echo app('translator')->get('lang.backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Full Project <?php echo app('translator')->get('lang.backup'); ?></button>
                          </span>
                          <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip" title="Disabled Database <?php echo app('translator')->get('lang.backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Database <?php echo app('translator')->get('lang.backup'); ?></button>
                          </span>
                    <?php else: ?>
                        <?php if(userPermission(460)): ?>
                            <a href="<?php echo e(route('get-backup-files',1)); ?>" class="primary-btn small fix-gr-bg  demo_view">
                                ...
                                Images <?php echo app('translator')->get('lang.backup'); ?>
                            </a>
                        <?php endif; ?> 
                        <?php if(userPermission(461)): ?>
                                <a href="<?php echo e(route('get-backup-files',2)); ?>" class="primary-btn small fix-gr-bg  demo_view">
                                <span class="ti-arrow-circle-down pr-2"></span>
                                Full Project <?php echo app('translator')->get('lang.backup'); ?>
                                </a>
                        <?php endif; ?> 
                        <?php if(userPermission(462)): ?>
                             <a href="<?php echo e(route('get-backup-db')); ?>" class="primary-btn small fix-gr-bg demo_view"> <span class="ti-arrow-circle-down pr-2"></span> Database <?php echo app('translator')->get('lang.backup'); ?> </a>
                        <?php endif; ?> 
                <?php endif; ?> 
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/systemSettings/backupSettings.blade.php ENDPATH**/ ?>