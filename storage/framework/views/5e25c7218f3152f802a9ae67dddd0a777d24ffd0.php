        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="news-img">
                        <img class="img-fluid news-image" src="<?php echo e(asset($news->image)); ?>" alt="">
                    </div>
                    <p class="mt-2">
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/frontEnd/home/light_news_details.blade.php ENDPATH**/ ?>