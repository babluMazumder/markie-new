...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.assign_class_teacher'); ?> </h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.academics'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.assign_class_teacher'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="<?php echo e(route('assign-class-teacher')); ?>" class="primary-btn small fix-gr-bg">
                    ...
                    <?php echo app('translator')->get('lang.assign'); ?>
                </a>
            </div>
        </div>
        <?php endif; ?>
                    ...
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30">
                                ...
                                <?php endif; ?>
                                    <?php echo app('translator')->get('lang.assign_class_teacher'); ?>
                            </h3>
                        </div>
                        <?php if(isset($assign_class_teacher)): ?>
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <label><?php echo app('translator')->get('lang.teacher'); ?> *</label><br>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('lang.class_teacher'); ?> <?php echo app('translator')->get('lang.list'); ?></h3>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('assign-class-teacher-edit',@$assign_class_teacher->id)); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                               <?php endif; ?>
                                                <?php if(userPermission(256)): ?>
                                                <a class="dropdown-item" data-toggle="modal" data-target="#deleteClassModal<?php echo e($assign_class_teacher->id); ?>"  href="<?php echo e(route('class_delete', [@$assign_class_teacher->id])); ?>"><?php echo app('translator')->get('lang.delete'); ?></a>
                                           <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->get('lang.delete'); ?> <?php echo app('translator')->get('lang.assign'); ?> <?php echo app('translator')->get('lang.teacher'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamppSF\htdocs\laravel\markie\markie_new\resources\views/backEnd/academics/assign_class_teacher.blade.php ENDPATH**/ ?>