                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                                                              ...
                                                                              <div class="input-effect">
                                                <input type="checkbox" id="gateway_Cash" class="common-checkbox class-checkbox read-only-input" name="gateways[1]" value="1" checked="">
                                                <label for="gateway_Cash">Cash  
                                                </label>
                                            </div>
                                            
                                        
                                                 <div class="input-effect">
                                                <input type="checkbox" id="gateway_Cheque" class="common-checkbox class-checkbox read-only-input" name="gateways[2]" value="2">
                                                <label for="gateway_Cheque">Cheque  
                                                </label>
                                            </div>
                                            
                                        
                                                <div class="input-effect">
                                                <input type="checkbox" id="gateway_Bank" class="common-checkbox class-checkbox read-only-input" name="gateways[3]" value="3">
                                                <label for="gateway_Bank">Bank  
                                                </label>
                                            </div>
                                            
                                        
                                                <div class="input-effect">
                                                <input type="checkbox" id="gateway_Stripe" class="common-checkbox class-checkbox read-only-input" name="gateways[4]" value="4" checked="">
                                                <label for="gateway_Stripe">Stripe  
                                                </label>
                                            </div>
                                            
                                        
                                                 <div class="input-effect">
                                                <input type="checkbox" id="gateway_Paystack" class="common-checkbox class-checkbox read-only-input" name="gateways[5]" value="5" checked="">
                                                <label for="gateway_Paystack">Paystack  
                                                </label>
                                            </div>
                                            
                                        
                                                <div class="input-effect">
                                                <input type="checkbox" id="gateway_Another" class="common-checkbox class-checkbox read-only-input" name="gateways[8]" value="8">
                                                <label for="gateway_Another">Another  
                                                </label>
                                            </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/systemSettings/academic_year.blade.php ENDPATH**/ ?>