...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.subject'); ?> <?php echo app('translator')->get('lang.wise'); ?> <?php echo app('translator')->get('lang.attendance'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.student_information'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.subject'); ?> <?php echo app('translator')->get('lang.wise'); ?> <?php echo app('translator')->get('lang.attendance'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <?php endif; ?>
                    <div class="white-box">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'subject-attendance-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_studentA'])); ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6  col-md-6 no-gutters text-md-left mark-holiday">
                            ...
                            <label for="mark_holiday"><?php echo app('translator')->get('lang.mark_holiday'); ?></label>
                        </button>
                        </div>
            <?php if(userPermission(534)): ?>
                        <div class="col-lg-6 col-md-6 text-md-right">
                            <button type="submit" class="primary-btn fix-gr-bg mb-20" onclick="javascript: form.action='<?php echo e(route('student-attendance-store')); ?>'">
            ...
            <?php endif; ?>
                    ...
                    <!-- <div class="d-flex justify-content-between mb-20"> -->
                        <!-- <button type="submit" class="primary-btn fix-gr-bg mr-20" onclick="javascript: form.action='<?php echo e(url('student-attendance-holiday')); ?>'">
                            ...
                            <?php echo app('translator')->get('lang.mark_as_holiday'); ?>
                        </button> -->
                        ...
                        <div class="col-lg-12">
                            <table id="table_id_table" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <?php endif; ?>
                                    <tr>
                                        <th width="5%"><?php echo app('translator')->get('lang.sl'); ?></th>
                                        <th width="10%"><?php echo app('translator')->get('lang.admission'); ?> <?php echo app('translator')->get('lang.no'); ?></th>
                                        <th width="15%"><?php echo app('translator')->get('lang.student'); ?> <?php echo app('translator')->get('lang.name'); ?></th>
                                        <th width="12%"><?php echo app('translator')->get('lang.roll'); ?> <?php echo app('translator')->get('lang.number'); ?></th>
                                        <th width="35%"><?php echo app('translator')->get('lang.attendance'); ?></th>
                                        <th width="20%"><?php echo app('translator')->get('lang.note'); ?></th>
                                    </tr>
                                </thead>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentInformation/subject_attendance.blade.php ENDPATH**/ ?>