                ...
                <div class="col-lg-4 no-gutters">
                    <div class="d-flex justify-content-between">
                        <div class="main-title">
                            <h3 class="mb-30"><?php echo app('translator')->get('lang.add_fees'); ?> </h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table id="" class="display school-table school-table-style-parent-fees" cellspacing="0"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <?php if($already_add==""): ?>
                                                        ...
                                                        <?php if(@$data['bank_info']->active_status == 1 || @$data['cheque_info']->active_status == 1): ?>
                                                            ...
                                                            <a class="dropdown-item modalLink"
                                                               ...
                                                               href="<?php echo e(route('fees-generate-modal-child', [$fees_assigned->fees_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id])); ?>"><?php echo app('translator')->get('lang.add'); ?> <?php echo app('translator')->get('lang.bank'); ?> <?php echo app('translator')->get('lang.payment'); ?></a>
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <a class="dropdown-item modalLink" data-modal-size="modal-lg"
                                                           title="<?php echo e($fees_assigned->feesGroupMaster->feesGroups->name.': '. $fees_assigned->feesGroupMaster->feesTypes->name); ?>"
                                                           href="<?php echo e(route('fees-generate-modal-child-view', [$fees_assigned->student_id,$fees_assigned->feesGroupMaster->fees_type_id])); ?>"><?php echo app('translator')->get('lang.view'); ?> <?php echo app('translator')->get('lang.bank'); ?> <?php echo app('translator')->get('lang.payment'); ?></a>
                                                    ...
                                                    <?php if(!empty($is_stripe) && $balance_amount !=0): ?>
                                                        ...
                                                        <a class="dropdown-item modalLink" data-modal-size="modal-lg"
                                                           ...
                                                           href="<?php echo e(route('fees-payment-stripe', [@$fees_assigned->feesGroupMaster->fees_type_id, $student->id, $rest_amount])); ?>">Pay
                                                            via Stripe</a>
                                                            ...
                                                            <form id="rzp-footer-form_<?php echo e($count); ?>"
                                                                ...
                                                                <div class="pay">
                                                                    <button class="dropdown-item razorpay-payment-button btn filled small"
                                                                            id="paybtn_<?php echo e($count); ?>" type="button">Pay via
                                                                        Razorpay
                                                                    </button>
                                                                </div>
                                                            </form>
                            ...
                            <?php $__currentLoopData = $fees_discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fees_discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php if(in_array(@$fees_discount->id, @$applied_discount)): ?>
                                        ...
                                        <?php else: ?>
                                            Discount
                                            of <?php echo e(@generalSetting()->currency_symbol); ?><?php echo e(@$fees_discount->feesDiscount->amount); ?>
                            ...
                            <tr>
                                <th></th>
                                <th></th>
                                <th><?php echo app('translator')->get('lang.grand'); ?> <?php echo app('translator')->get('lang.total'); ?> (<?php echo e(@generalSetting()->currency_symbol); ?>)
                                </th>
                                <th></th>
                                <th><?php echo e(@$grand_total+$total_fine); ?></th>
                                <th></th>
                                <th></th>
                                <th></th>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/studentPanel/fees_pay.blade.php ENDPATH**/ ?>