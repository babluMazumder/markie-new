                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php echo e($online_exam->date != ""? dateConvert($online_exam->date):''); ?>
                                     ...
                                     <br> <?php echo app('translator')->get('lang.time'); ?>: <?php echo e(date("h:i A", strtotime($online_exam->start_time)).' - '.date("h:i A", strtotime($online_exam->end_time))); ?></td>
                                    <td>
                                        ...
                                        <div class="dropdown d-flex">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <?php if(!empty($is_set_online_exam_questions)): ?> 
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if($online_exam->start_time < $present_time && $online_exam->status == 1): ?>
                                            ...
                                            <?php if(empty($is_set_online_exam_questions)): ?> 
                                                <?php if(userPermission(242)): ?> 
                                                    <a class="primary-btn small bg-success text-white border-0" href="<?php echo e(route("manage_online_exam_question", [$online_exam->id])); ?>">
                                            ...
                                            <?php else: ?>
                                             ...
                                             <?php if($online_exam->end_date_time < $present_date_time && $online_exam->status == 1): ?>
                                                ...
                                                <a class="ml-3" href="<?php echo e(route('online_exam_result', [$online_exam->id])); ?>">
                                                    <button class="primary-btn small bg-info text-white border-0"><?php echo app('translator')->get('lang.result'); ?></button>
                                                </a>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maxicare/hwti.sch.ng/resources/views/backEnd/examination/online_exam.blade.php ENDPATH**/ ?>