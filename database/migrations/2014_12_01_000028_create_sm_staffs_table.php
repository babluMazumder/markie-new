...
class CreateSmStaffsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_staffs', function (Blueprint $table) {
            ...
            $table->foreign('designation_id')->references('id')->on('sm_designations')->onDelete('cascade');

            $table->integer('department_id')->nullable()->unsigned()->default(1);
            $table->foreign('department_id')->references('id')->on('sm_human_departments')->onDelete('cascade');
